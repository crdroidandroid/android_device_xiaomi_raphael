...
public class Constants {
    ...
    public static final String BREATH_BLUE_LED_PATH = "/sys/class/leds/blue/breath";
    public static final String BREATH_GREEN_LED_PATH = "/sys/class/leds/green/breath";
